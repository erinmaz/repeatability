...
#have already manually run in GUI for bh1_09
e2dof=`cat ${MAINDIR}/R02/sess1/nii/rBH1_e2_cropped_nan_gm_sm_bh1_09.feat/stats/dof`
fdr_cor.sh ${MAINDIR}/R02/sess1/nii/rBH1_e2_cropped_nan_gm_sm_bh1_09.feat/stats $q $e2dof
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess1/nii/rBH1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess1/nii/rBH2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess2/nii/rBH1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess2/nii/rBH2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess1/nii/rHC1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess1/nii/rHC2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do 
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess2/nii/rHC1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do 
  ...
  fdr_cor.sh ${MAINDIR}/R02/sess2/nii/rHC2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof
done
...
do 
  ...
  fdr_cor.sh ${MAINDIR}/${r}/${s}/nii/rHC1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof 
done
...
do 
  ...
  fdr_cor.sh ${MAINDIR}/${r}/${s}/nii/rHC2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof 
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/${r}/${s}/nii/rBH1_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof 
done
...
do
  ...
  fdr_cor.sh ${MAINDIR}/${r}/${s}/nii/rBH2_e2_cropped_nan_gm_sm_${run}.feat/stats $q $e2dof 
done
