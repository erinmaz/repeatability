...
fslchfiletype NIFTI /Users/erin/Desktop/Projects/Repeatability/working/${sub}/${sess}/nii/${run}_${hrf}_CVR_sig_e2_movie_cropped
fslchfiletype NIFTI /Users/erin/Desktop/Projects/Repeatability/working/${sub}/${sess}/nii/${run}_${hrf}_CVR_sig_e1_movie_cropped
done
done
done
done
