function [ROI_vICC_2A_con v_ICC_2A_con v_cv v_numvoxels]=intravoxel_rel_erin(cluster_mask_files,dim,activation_files)
...
v_cv=cv
fprintf('\n')
fprintf('Number of voxels going into calculations: \n')
v_numvoxels=numvoxels
