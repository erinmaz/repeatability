...
newdof=$(expr $dof - 1)
fdr_cor.sh /Users/erin/Desktop/Projects/Repeatability/working/R02/sess1/nii/rBH1_e1_cropped_nan_gm_sm_sub_clt-tagmask_bptf_${run}.feat/stats_rawfile_nothr $q $newdof
