...
# output: cope1_baseline and cope1_psc (in stats dir of input feat dir)
...
fslmaths ${1}/stats/cope1 -mul $avgReg -mul -1 -add ${1}/mean_func ${1}/stats/cope1_baseline
fslmaths ${1}/stats/cope1 -div ${1}/stats/cope1_baseline ${1}/stats/cope1_psc

#fslmaths ${1}/stats/cope2 -mul $avgReg -mul -1 -add ${1}/mean_func ${1}/stats/cope2_baseline
#fslmaths ${1}/stats/cope2 -div ${1}/stats/cope2_baseline ${1}/stats/cope2_psc
