...
do
echo -n $sub $sess $run " "
actvoltmp=(`fslstats ${MAINDIR}/${sub}/${sess}/nii/srBH1_e1_cropped_sub_${run}.feat/thresh_zstat1 -k ${MAINDIR}/${sub}/${sess}/nii/c1T1.8_to_BH1 -V`)
...
do
echo -n $sub $sess $run " "
actvoltmp=(`fslstats ${MAINDIR}/${sub}/${sess}/nii/srBH2_e1_cropped_sub_${run}.feat/thresh_zstat1 -k ${MAINDIR}/${sub}/${sess}/nii/c1T1.8_to_BH2 -V`)
actvol=`echo ${actvoltmp[1]}`
awk -v actvol=$actvol -v gmvol=$gmvol 'BEGIN {print actvol/gmvol}'
done
done
...
do
echo -n $sub $sess $run " "
actvoltmp=(`fslstats ${MAINDIR}/${sub}/${sess}/nii/srHC1_e1_cropped_sub_${run}.feat/thresh_zstat1 -k ${MAINDIR}/${sub}/${sess}/nii/c1T1.8_to_HC1 -V`)
actvol=`echo ${actvoltmp[1]}`
awk -v actvol=$actvol -v gmvol=$gmvol 'BEGIN {print actvol/gmvol}'
done
done
...
do
echo -n $sub $sess $run " "
actvoltmp=(`fslstats ${MAINDIR}/${sub}/${sess}/nii/srHC2_e1_cropped_sub_${run}.feat/thresh_zstat1 -k ${MAINDIR}/${sub}/${sess}/nii/c1T1.8_to_HC2 -V`)
actvol=`echo ${actvoltmp[1]}`
awk -v actvol=$actvol -v gmvol=$gmvol 'BEGIN {print actvol/gmvol}'
done
done
